...
public class SecurityFilter implements Filter {
    ...
    HttpSession session;
    String userName, defaultUserName, requestingServlet;
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        requestingServlet = httpRequest.getRequestURI();
        
        if (requestingServlet.equalsIgnoreCase("/HIT337Assignment1/Logout")) {
            session.removeAttribute("userName");
        }
        
        if (requestingServlet.equalsIgnoreCase("/HIT337Assignment1/LoginServlet")) {
        ...
        if (session.getAttribute("userName") != null) {
            ...
            defaultUserName = getFilterConfig().getServletContext().getInitParameter("DefaultUser");

            if (requestingServlet.equalsIgnoreCase("/HIT337Assignment1/AddEditDelete")) {
                dispatcher = request.getRequestDispatcher("AddEditDeleteServlet");
            } else {
