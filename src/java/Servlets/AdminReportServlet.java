...
public class AdminReportServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            displayWelcomePage(out);
        }
    }

    void displayWelcomePage(PrintWriter out) {
                ...
                try {
                    ...
                    if (myList != null) {
                        ...
                        for (int index = 0; index < myList.size(); index++) {
                            ...
                            out.println("<td>" + myList.get(index).getUserName() + "</td>");
                        ...
                        out.println("<tr><td colspan=7><input type='button' name='add' value='Add New Record' onclick='{document.adminRecords.selectedAction.value=this.value; document.adminRecords.submit();}'/></td></tr>");
                        out.println("</tbody>");
                        out.println("</table>");
                        out.println("</form>");
                    }
